      ...
      <div className="">
        ...
        <div className="grid grid-cols-2 gap-8 m-8 text-justify text-lg tracking-wide">
          ...
          <div className="shadow-lg p-4 rounded-lg">
            ...
            <p>
              One useful aspect of bracket notation is that it can be used to
              set not only member values dynamically, but member names too.
              Adding a property to an object using the method above isn't
              possible with dot notation
            </p>
          </div>
          <div className="shadow-lg p-4 rounded-lg bg-slate-50">
            ...
            of bio: function () we can write bio(). Like this: An object
            property can itself be an object.
          </div>

          <div className="shadow-lg p-4 rounded-lg bg-slate-50">
            An object like this is referred to as an object literal — we've
            literally written o ut the object contents as we've come to create
            it. This is different compared to objects instantiated from classes,
            ...
            <div className="grid grid-cols-5 gap-1">
              <div className="col-span-5 p-2 shadow bg-slate-200">
                <p className="leading-loose">
                  ...
                  like{" "}
                  <span className="font-medium italic underline">Array</span>{" "}
                  and{" "}
                  <span className="font-medium italic underline">String</span>{" "}
                  can be{" "}
                  <span className="font-medium italic underline">spread</span>{" "}
                  in{" "}
                  <span className="font-medium italic underline">
                    array literals
                  </span>{" "}
                ...
                <p className="leading-loose mb-3">
                  Many objects are not iterable, including all plain objects
                  that lack a Symbol.iterator method:
                </p>
                <p className="leading-normal mb-2">
                  On the other hand, spreading in object literals enumerates the
                  own properties of the value. For typical arrays, all indices
                  are enumerable own properties, so arrays can be spread into
                  objects.
                </p>
